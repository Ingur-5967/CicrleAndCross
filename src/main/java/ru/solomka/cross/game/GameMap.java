...
public class GameMap {
    ...
    public List<List<IntPair>> getTacticalPosition() {
        return List.of(
                List.of(new IntPair(0, 0), new IntPair(0, 1), new IntPair(0, 2)),
                List.of(new IntPair(1, 0), new IntPair(1, 1), new IntPair(1, 2)),
                List.of(new IntPair(1, 0), new IntPair(1, 1), new IntPair(1, 2)),
                List.of(new IntPair(2, 0), new IntPair(2, 1), new IntPair(2, 2)),
                List.of(new IntPair(0, 0), new IntPair(1, 0), new IntPair(2, 0)),
                List.of(new IntPair(0, 1), new IntPair(1, 1), new IntPair(2, 1)),
                List.of(new IntPair(0, 2), new IntPair(1, 2), new IntPair(2, 2)),
                List.of(new IntPair(0, 0), new IntPair(1, 1), new IntPair(2, 2)),
                List.of(new IntPair(0, 2), new IntPair(1, 1), new IntPair(0, 2))
        );
    }
}